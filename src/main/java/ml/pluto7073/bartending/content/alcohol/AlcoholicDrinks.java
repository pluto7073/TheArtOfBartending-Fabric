...
public final class AlcoholicDrinks {
    ...
    public static final AlcoholicDrink BEER = register("beer", new AlcoholicDrink.Builder().proof(10).ounces(12)
            ...
            .addStep(new BarrelAgingBrewerStep(BarrelPredicate.ANY, 3, 1))
    ...
    public static final AlcoholicDrink WHEAT_BEER = register("wheat_beer", new AlcoholicDrink.Builder().proof(8).ounces(12)
            .addStep(new FermentingBrewerStep.Builder().addIngredient(Ingredient.of(Items.WHEAT), 12, 2)
                    .setTicks(9600).setLeeway(600).build())
            .addStep(new BarrelAgingBrewerStep(new BarrelPredicate(BartendingBlocks.BARRELS.get(WoodType.BIRCH)), 2, 1))
    ...
    public static final AlcoholicDrink DARK_BEER = register("dark_beer", new AlcoholicDrink.Builder().proof(16).ounces(12)
            .addStep(new FermentingBrewerStep.Builder().addIngredient(Ingredient.of(Items.WHEAT), 24, 4)
                    .setTicks(9600).setLeeway(600).build())
            .addStep(new BarrelAgingBrewerStep(new BarrelPredicate(BartendingBlocks.BARRELS.get(WoodType.DARK_OAK)), 9, 2))
    ...
    public static final AlcoholicDrink MEAD = register("mead", new AlcoholicDrink.Builder().proof(20).ounces(5)
            .addStep(new FermentingBrewerStep.Builder().addIngredient(Ingredient.of(Items.HONEY_BOTTLE), 4, 2)
    ...
    public static final AlcoholicDrink RED_WINE = register("red_wine", new AlcoholicDrink.Builder().proof(24).ounces(5)
            .addStep(new FermentingBrewerStep.Builder().addIngredient(Ingredient.of(BartendingItems.RED_GRAPE), 192, 32)
                    .setTicks(24000).setLeeway(2400).build())
            .addStep(new BarrelAgingBrewerStep(BarrelPredicate.ANY, 1, 0, -1))
    ...
    public static final AlcoholicDrink CHAMPAGNE = register("champagne", new AlcoholicDrink.Builder().proof(24).ounces(5)
            .addStep(new BottleFermentingBrewerStep(
                    1,
                    BarrelPredicate.ANY,
                    () -> BartendingItems.WHITE_WINE
            )).name("Champagne").color(0xe2c36c)
            .bottle(BartendingItems.WINE_BOTTLE).build());
    public static final AlcoholicDrink SWEET_BERRY_WINE = register("sweet_berry_wine", new AlcoholicDrink.Builder().proof(24).ounces(5)
            ...
            .color(0x2b0010).build());
    public static final AlcoholicDrink GLOW_BERRY_WINE = register("glow_berry_wine", new AlcoholicDrink.Builder().proof(24).ounces(5)
            .addStep(new FermentingBrewerStep.Builder().addIngredient(Ingredient.of(Items.GLOW_BERRIES), 192, 32)
                    .setLeeway(24000).setLeeway(2400).build())
            .addStep(new BarrelAgingBrewerStep(BarrelPredicate.ANY, 1, 0, -1))
    ...
    public static final AlcoholicDrink CRIMSON_WINE = register("crimson_wine", new AlcoholicDrink.Builder().proof(52).ounces(5)
            .addStep(new FermentingBrewerStep.Builder()
                    ...
                    .setTicks(36000).setLeeway(3600).build())
            .addStep(new BarrelAgingBrewerStep(BarrelPredicate.ofWood(WoodType.CRIMSON), 2, 1, -1))
    ...
    public static final AlcoholicDrink WARPED_WINE = register("warped_wine", new AlcoholicDrink.Builder().proof(56).ounces(5)
            .addStep(new FermentingBrewerStep.Builder()
                    ...
                    .setTicks(36000).setLeeway(3600).build())
            .addStep(new BarrelAgingBrewerStep(BarrelPredicate.ofWood(WoodType.WARPED), 2, 1, -1))
    ...
    public static final AlcoholicDrink APPLE_LIQUEUR = register("apple_liqueur", new AlcoholicDrink.Builder()
            .proof(60).ounces(1.5f).addStep(new FermentingBrewerStep.Builder()
    ...
    public static final AlcoholicDrink WHISKEY = register("whiskey", new AlcoholicDrink.Builder().proof(80).ounces(1.5f)
            .addStep(new FermentingBrewerStep.Builder()
                    ...
                    .setTicks(18000).setLeeway(3600).build())
            .addStep(new BarrelAgingBrewerStep(BarrelPredicate.ofWood(WoodType.OAK), 10, 2))
